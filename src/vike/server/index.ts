...
async function startServer() {
    ...
    if (isProduction) {
        ...
        // We instantiate Vite's development server and integrate its middleware
        // to our server.
        // ⚠️ We instantiate it only in development. (It isn't needed in
        // production and it would unnecessarily bloat our production server.)
